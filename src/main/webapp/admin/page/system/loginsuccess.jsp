...
<link rel="stylesheet" href="<%=path %>/easyui/themes/default/easyui.css" type="text/css"></link>
 ...
 <script type="text/javascript" src="<%=path %>/admin/js/loginsuccess.js"></script>

</head>
<body>

 <table id="tabs" class="easyui-datagrid"  
        data-options="fit:true,url:'<%=path %>/login-log!findLoginSucLog.action',fitColumns:true,pagination:true,rownumbers:true,pageList:[10,15,20],pageSize:10,toolbar:'#toolbar'">   
    <thead>   
        <tr> 
        	<th data-options="field:'ck',checkbox:true"></th>  
            <th data-options="field:'id'">编号</th>   
            <th data-options="field:'user',width:100,formatter:format3,align:'center'">用户名</th>
...
用户名:<input class="easyui-validatebox" id="tjName"/>
